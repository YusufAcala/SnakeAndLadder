...
public class Sound  {
    ...
    public Sound() throws UnsupportedAudioFileException, IOException, LineUnavailableException{
        this.upFile = new File("C:\\Users\\LENOVO\\Documents\\Programming\\Java\\Snake and Ladder\\slide_up.wav");
        this.downFile = new File("C:\\Users\\LENOVO\\Documents\\Programming\\Java\\Snake and Ladder\\slide_down.wav");
        this.walkFile = new File("C:\\Users\\LENOVO\\Documents\\Programming\\Java\\Snake and Ladder\\move.wav");
        this.diceFile = new File("C:\\Users\\LENOVO\\Documents\\Programming\\Java\\Snake and Ladder\\dice.wav");
        this.backsoundFile = new File("C:\\Users\\LENOVO\\Documents\\Programming\\Java\\Snake and Ladder\\backsound.wav");
        this.winFile = new File("C:\\Users\\LENOVO\\Documents\\Programming\\Java\\Snake and Ladder\\win.wav");
